...
export default function Daad() {
  ...
  React.useEffect(() => {
    ...
    document.title = "DAAD WISE | Scholarships";
  ...
  return (
    <>
      ...
      <div className="wrapper">
        ...
        <ProfilePageHeader title={"DAAD-WISE 2020"} img={"DAAD.jpg"} />
                  ...
                  <div style={{ padding: 6 }}>
                    ...
                    >
                      <span style={{ fontSize: 18 }}>
                        <img
                          width={287}
                          src={require("assets/img/daad1.jpg")}
                          align="left"
                    ...
                    >
                      <span style={{ fontSize: 18 }}>
                        <img
                          width={290}
                          src={require("assets/img/daad2.jpg")}
                          align="left"
                          className="fr-fil fr-dii"
                          style={{ padding: 8 }}
                        />
                    ...
                    >
                      <span style={{ fontSize: 18 }}>
                        <img
                          width={268}
                          src={require("assets/img/daad3.jpg")}
                          align="left"
                          className="fr-fil fr-dii"
                          style={{ padding: 8 }}
                        />
                    ...
                    >
                      <span style={{ fontSize: 18 }}>
                        <span style={{ fontFamily: '"Times New Roman",serif' }}>
                          ...
                          I hope this article can be of help to some students. I
                          also wrote up a series of articles in 2019 trying my
                          best to answer many questions regarding graduate
                          school admissions and internship experience of some of
                          my friends. These can be found{" "}
                          <a href="https://www.rokystech.com/search/label/grad%20school?m=1">
                            <span
                              style={{ fontFamily: '"Times New Roman",serif' }}
                            >
                              here.
